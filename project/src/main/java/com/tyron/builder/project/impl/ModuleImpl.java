    ...
    public void open() throws IOException {
        ...
        if (!buildSettings.exists()) {
            ...
            try {
                ...
                kotlinSettings.put("language_version", LanguageVersion.LATEST_STABLE.getVersionString());
            ...
            try {
                ...
                JSONObject kotlinSettings = buildSettingsJson.getJSONObject("kotlin");

                if (kotlinSettings.optJSONObject("language_version") == null) {
                    kotlinSettings.put("language_version", LanguageVersion.LATEST_STABLE.getVersionString());
                    FileWriter fileWriter = new FileWriter(buildSettings, false);
                    fileWriter.write(buildSettingsJson.toString(1));
                    fileWriter.close();
                }
