...
public class JavaCommonActionGroup extends ActionGroup {

    public static final String ID = "javaCommonActionGroup";
    ...
    public void update(@NonNull AnActionEvent event) {
        ...
        presentation.setText("Java Helpers");
    }
