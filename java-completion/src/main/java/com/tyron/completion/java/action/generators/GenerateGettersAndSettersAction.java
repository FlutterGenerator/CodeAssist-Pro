...
import com.tyron.completion.java.rewrite.GenerateGettersAndSetters;
...
public class GenerateGettersAndSettersAction extends AnAction {

    public static final String ID = "javaGenerateGettersAndSettersAction";
    ...
    public void update(@NonNull AnActionEvent event) {
        ...
        presentation.setText(event.getDataContext().getString(R.string.menu_generators_generate_getters_setters_title));
    }
    ...
    public void actionPerformed(@NonNull AnActionEvent e) {
        ...
        new MaterialAlertDialogBuilder(activity)
                .setTitle(R.string.menu_generators_generate_getters_setters_title)
                ...
                .setPositiveButton(android.R.string.ok, (dialog, which) -> {
                    ...
                    if (!selectedFields.isEmpty()) {
                        GenerateGettersAndSetters rewrite = new GenerateGettersAndSetters(selectedFields, editor.getCaret().getStart());
