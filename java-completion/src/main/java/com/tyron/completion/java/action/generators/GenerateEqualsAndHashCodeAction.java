...
import com.tyron.completion.java.rewrite.GenerateEqualsAndHashCode;
...
public class GenerateEqualsAndHashCodeAction extends AnAction {

    public static final String ID = "javaGenerateEqualsAndHashCodeAction";
    ...
    public void update(@NonNull AnActionEvent event) {
        ...
        presentation.setText("Generate equals() and hashCode()");
    }
    ...
    public void actionPerformed(@NonNull AnActionEvent e) {
        ...
        new MaterialAlertDialogBuilder(e.getDataContext())
                .setTitle("Generate equals() and hashCode()")
                ...
                .setPositiveButton(android.R.string.ok, (dialog, which) -> {
                    ...
                    GenerateEqualsAndHashCode rewrite = new GenerateEqualsAndHashCode(selectedFields, editor.getCaret().getStart());
