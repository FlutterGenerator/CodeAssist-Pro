...
//
//    final int origStartPos = (int) trees.getSourcePositions().getStartPosition(cu, orig.getBody());
//    final int origEndPos = (int) trees.getSourcePositions().getEndPosition(cu, orig.getBody());
//    if (origStartPos < 0) {
//      LOGGER.log(
//          Level.WARNING, "Javac returned startpos: {0} < 0", new Object[] {origStartPos}); // NOI18N
//      return false;
//    }
//    if (origStartPos > origEndPos) {
//      LOGGER.log(
//          Level.WARNING,
//          "Javac returned startpos: {0} > endpos: {1}",
...
//        LOGGER.log(Level.FINER, "Skip reparse method (old local classes): {0}", newBody); // NOI18N
//      }
//      return false;
//    }
...
//        LOGGER.log(
//            Level.FINER,
//            "Skip reparse method, invalid position, newBody: ",
//            // NOI18N
//            newBody);
//        return false;
//      }
...
//        return false;
//      }
//      Map<JCTree, LazyDocCommentTable.Entry> docCommentsTable =
//          ((LazyDocCommentTable) ((JCTree.JCCompilationUnit) cu).docComments).table;
...
//      tpv.scan(cu, null);
//      Enter.instance(ctx)
//          .unenter(((JCTree.JCCompilationUnit) cu), ((JCTree.JCMethodDecl) orig).body);
...
//  }
//
//  public JCTree.JCBlock reparseMethodBody(
//      Context ctx,
//      CompilationUnitTree topLevel,
//      MethodTree methodToReparse,
//      String newBodyText,
//      final Map<JCTree, LazyDocCommentTable.Entry> docComments)
...
//            ctx,
//            buf,
//            ((JCTree.JCBlock) methodToReparse.getBody()).pos,
...
//  }
//
//  public BlockTree reattrMethodBody(
//      Context context, Scope scope, MethodTree methodToReparse, BlockTree block)
...
//                "compiler", "call.to.super.not.allowed.in.enum.ctor", env.enclClass.sym));
//      }
//    }
...
//  }
//
//  public BlockTree reflowMethodBody(
//      Context context,
//      CompilationUnitTree topLevel,
...
//  }
//
//  private com.sun.tools.javac.parser.JavacParser newParser(
//      Context context, CharSequence input, int startPos, final EndPosTable endPos) {
...
//    }
//    return new NBParserFactory.NBJavacParser(
//        parserFactory, lexer, true, false, true, false, cancelService) {
//      @Override
