...
import com.tyron.completion.java.rewrite.GenerateConstructor;
...
public class GenerateConstructorAction extends AnAction {

    public static final String ID = "javaGenerateConstructorAction";
    ...
    public void update(@NonNull AnActionEvent event) {
        ...
        presentation.setText(event.getDataContext().getString(R.string.menu_generators_generate_constructor_title));
    }
    ...
    public void actionPerformed(@NonNull AnActionEvent e) {
        ...
        new MaterialAlertDialogBuilder(activity)
                ...
                .setPositiveButton(android.R.string.ok, (dialog, which) -> {
                    ...
                    GenerateConstructor rewrite = new GenerateConstructor(selectedFields, editor.getCaret().getStart());
