...
import com.itsaky.androidide.compose.preview.compiler.ComposeCompiler.ProcessResult
...
//            val argsLine = "COMPILE\u0000" + args.joinToString("\u0000") + "\n"
            ...
            try {
                ...
                val hasErrors = output.contains("error:")
...
//            ensureDaemonRunning()
            ...
            try {
                ...
                classpathManager.getRuntimeJars()
                    .filter { it.exists() }
                    .forEach { jar ->
                        builder.addClasspathFiles(jar.toPath())
                    }

                if (BuildModule.getAndroidJar().exists()) {
                    builder.addLibraryFiles(BuildModule.getAndroidJar().toPath())
                }
