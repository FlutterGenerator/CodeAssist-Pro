...
abstract class ExecOperationsTask @Inject constructor(
    @get:Internal
    val execOperations: ExecOperations
) : DefaultTask()

val compileRuntimeDex by tasks.registering(ExecOperationsTask::class){
