...
public class InitializationOptionsExtendedClientCapabilities {
   ...
   * @return the "extendedClientCapabilities" section of {@link
   *     InitializeParams#getInitializationOptions()}.
   */
  public static ExtendedClientCapabilities getExtendedClientCapabilities(
      InitializeParams initializeParams) {
    InitializationOptionsExtendedClientCapabilities root =
        JSONUtility.toModel(
            initializeParams.getInitializationOptions(),
