...
public class XMLCompletionSettings {
  ...
  /**
   * Returns true if turning a start tag into a self closing tag should remove the content of the
   * element and false otherwise
   *
   * @return true if turning a start tag into a self closing tag should remove the content of the
   *     element and false otherwise
   */
  ...
  /**
   * Returns <code>true</code> if the client support snippet and <code>false</code> otherwise.
   *
   * @return <code>true</code> if the client support snippet and <code>false</code> otherwise.
   */
  public boolean isCompletionSnippetsSupported() {
    return completionCapabilities != null
        && completionCapabilities.getCompletionItem() != null
  ...
  /**
   * Returns true if the client supports resolving the given {@link
   * CompletionResolveSupportProperty} property in completionItem/resolve and false otherwise.
   *
   * @return true if the client supports resolving the given {@link
   *     CompletionResolveSupportProperty} property in completionItem/resolve and false otherwise
   */
  ...
  /**
   * Returns <code>true</code> if the client support completion list itemDefaults given the field
   * and <code>false</code> otherwise.
   *
   * @param field the completionList itemDefaults field
   * @return <code>true</code> if the client support completion list itemDefaults given the field
   *     and <code>false</code> otherwise.
   */
  public boolean isCompletionListItemDefaultsSupport(String field) {
    return completionCapabilities != null
        && completionCapabilities.getCompletionList() != null
