...
public class LogsSettings {
  ...
  /**
   * Returns <code>true</code> if LSP client is enabled and <code>false</code> otherwise.
   *
   * @return <code>true</code> if LSP client is enabled and <code>false</code> otherwise.
   */
