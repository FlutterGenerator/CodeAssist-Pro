 ...
 *
 * <p>See https://github.com/eclipse/lemminx/blob/main/docs/Configuration.md for more information.
 *
 * <p>This class is created through the deseralization of a JSON object. Each internal setting must
 * be represented by a class and have:
 *
 * <p>1) A constructor with no parameters
 *
 * <p>2) The JSON key/parent for the settings must have the same name as a varible.
 *
 * <p>eg: {"format" : {...}, "completion" : {...}}
 *
 * <p>In this class must exist both a "format" and "completion" variable with the appropriate Class
 * to represent the value of each key
 */
public class XMLGeneralClientSettings {
  ...
  /**
   * Returns a new instance of <code>XMLGeneralClientSettings</code> with contents from <code>
   * initializationOptionsSettings</code>
   *
   * @param initializationOptionsSettings
   * @return a new instance of <code>XMLGeneralClientSettings</code> with contents from <code>
   *     initializationOptionsSettings</code>
   */
  public static XMLGeneralClientSettings getGeneralXMLSettings(
