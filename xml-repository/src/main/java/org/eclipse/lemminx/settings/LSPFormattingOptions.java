 ...
 *
 * <p>This class redefines the LSP4J {@link FormattingOptions} without extending {@link
 * LinkedHashMap} (public class FormattingOptions extends LinkedHashMap<String, Either3<String,
 * Number, Boolean>> {).
 *
 * <p>FormattingOptions can support only String, Number, Boolean, but not Array of String. It is the
 * reason why LemMinX redefines LSPFormattingOptions.
 */
