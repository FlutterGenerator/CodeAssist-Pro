...
public class XMLSymbolFilter extends PathPatternMatcher {
   ...
   * @return the first matched attribute node that is set as an inline attribute for an element, or
  ...
  /**
   * Returns true if the filter have an expression for the given type (element, attribute, text) and
   * false otherwise.
   *
   * @param matcherType the matcher type.
   * @return true if the filter have an expression for the given type (element, attribute, text) and
   *     false otherwise.
   */
