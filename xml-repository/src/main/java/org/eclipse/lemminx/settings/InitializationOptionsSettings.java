...
public class InitializationOptionsSettings {
  ...
  /**
   * Returns the "settings" section of {@link InitializeParams#getInitializationOptions()}.
   *
   * <p>Here a sample of initializationOptions
   *
   * <pre>
   ...
   * @return the "settings" section of {@link InitializeParams#getInitializationOptions()}.
   */
  public static Object getSettings(InitializeParams initializeParams) {
    InitializationOptionsSettings root =
        JSONUtility.toModel(
            initializeParams.getInitializationOptions(), InitializationOptionsSettings.class);
