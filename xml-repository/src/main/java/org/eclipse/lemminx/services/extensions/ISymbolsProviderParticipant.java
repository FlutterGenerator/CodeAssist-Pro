...
public interface ISymbolsProviderParticipant {
   ...
   *
   * <ul>
   *   <li>{@link SymbolStrategy#UNADAPTABLE} : means that the participant is not applicable for the
   *       document
   *   <li>{@link SymbolStrategy#INSERT} : means that the participant will insert symbols on the top
   *       of the standards symbols. *
   *   <li>{@link SymbolStrategy#REPLACE} : means that the participant will replace the standard XML
   *       symbols with their own symbols.
   * </ul>
   *
