...
public class XMLLanguageService extends XMLExtensionsRegistry implements IXMLFullFormatter {
  ...
  public String formatFull(
      String text, String uri, SharedSettings sharedSettings, CancelChecker cancelChecker) {
  ...
  public List<DocumentSymbol> findDocumentSymbols(
      DOMDocument xmlDocument, XMLSymbolSettings symbolSettings) {
  ...
  public CompletionList doComplete(
      DOMDocument xmlDocument, Position position, SharedSettings settings) {
  ...
  public CompletionItem resolveCompletionItem(
      ...
      CancelChecker cancelChecker) {
    return completions.resolveCompletionItem(
        unresolved, xmlDocument, sharedSettings, cancelChecker);
  }
  ...
  public List<Diagnostic> doDiagnostics(
      DOMDocument xmlDocument,
      XMLValidationSettings validationSettings,
      Map<String, Object> validationArgs,
      CancelChecker cancelChecker) {
    return diagnostics.doDiagnostics(
        xmlDocument, validationSettings, validationArgs, cancelChecker);
  }

  public CompletableFuture<Path> publishDiagnostics(
      DOMDocument xmlDocument,
    ...
    XMLValidationSettings validationSettingsForUri =
    ...
    DiagnosticsResult diagnostics =
        (DiagnosticsResult)
            this.doDiagnostics(
                xmlDocument, validationSettingsForUri, validationArgs, cancelChecker);
  ...
  public List<FoldingRange> getFoldingRanges(
      DOMDocument xmlDocument, XMLFoldingSettings context, CancelChecker cancelChecker) {
  ...
  public List<SelectionRange> getSelectionRanges(
      DOMDocument xmlDocument, List<Position> positions, CancelChecker cancelChecker) {
    return selectionRanges.getSelectionRanges(xmlDocument, positions, cancelChecker);
  }

  public Either<Range, PrepareRenameResult> prepareRename(
      DOMDocument xmlDocument, Position position, CancelChecker cancelChecker) {
    return prepareRename.prepareRename(xmlDocument, position, cancelChecker);
  }

  public WorkspaceEdit doRename(
      DOMDocument xmlDocument, Position position, String newText, CancelChecker cancelChecker) {
  ...
  public List<ColorInformation> findDocumentColors(
      DOMDocument xmlDocument, CancelChecker cancelChecker) {
    return documentColor.findDocumentColors(xmlDocument, cancelChecker);
  }

  public List<ColorPresentation> getColorPresentations(
      DOMDocument xmlDocument, ColorPresentationParams params, CancelChecker cancelChecker) {
    return documentColor.getColorPresentations(xmlDocument, params, cancelChecker);
  }

  public List<? extends LocationLink> findDefinition(
      DOMDocument xmlDocument, Position position, CancelChecker cancelChecker) {
    return definition.findDefinition(xmlDocument, position, cancelChecker);
  }

  public List<? extends LocationLink> findTypeDefinition(
      DOMDocument xmlDocument, Position position, CancelChecker cancelChecker) {
    return typeDefinition.findTypeDefinition(xmlDocument, position, cancelChecker);
  }

  public List<? extends Location> findReferences(
      DOMDocument xmlDocument,
      Position position,
  ...
  public List<? extends CodeLens> getCodeLens(
      DOMDocument xmlDocument, XMLCodeLensSettings settings, CancelChecker cancelChecker) {
    return codelens.getCodelens(xmlDocument, settings, cancelChecker);
  }

  public List<CodeAction> doCodeActions(
  ...
  public CodeAction resolveCodeAction(
      CodeAction unresolved,
      DOMDocument document,
      SharedSettings sharedSettings,
      CancelChecker cancelChecker) {
  ...
  public AutoCloseTagResponse doTagComplete(
      DOMDocument xmlDocument, XMLCompletionSettings completionSettings, Position position) {
  ...
  public AutoCloseTagResponse doAutoClose(
      DOMDocument xmlDocument,
      Position position,
      XMLCompletionSettings completionSettings,
      CancelChecker cancelChecker) {
  ...
  public Position getMatchingTagPosition(
      DOMDocument xmlDocument, Position position, CancelChecker cancelChecker) {
    return XMLPositionUtility.getMatchingTagPosition(xmlDocument, position);
  }

  /**
   * Returns the linked editing ranges for the given <code>xmlDocument</code> at the given <code>
   * position</code> and null otherwise.
   *
   * @param xmlDocument the DOM document.
   * @param position the position.
   * @param cancelChecker the cancel checker.
   * @return the linked editing ranges for the given <code>xmlDocument</code> at the given <code>
   *     position</code> and null otherwise.
   */
  public LinkedEditingRanges findLinkedEditingRanges(
      DOMDocument xmlDocument, Position position, CancelChecker cancelChecker) {
