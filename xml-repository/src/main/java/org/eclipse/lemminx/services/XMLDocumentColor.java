...
class XMLDocumentColor {
  ...
  public List<ColorInformation> findDocumentColors(
    ...
    for (IDocumentColorParticipant participant :
        extensionsRegistry.getDocumentColorParticipants()) {
      try {
        ...
        LOGGER.log(
            Level.SEVERE,
            "Error while processing document color for the participant '"
  ...
  public List<ColorPresentation> getColorPresentations(
    ...
    for (IDocumentColorParticipant participant :
      ...
      try {
        ...
        LOGGER.log(
            Level.SEVERE,
            "Error while processing color presentation for the participant '"
                + participant.getClass().getName()
                + "'.",
            e);
      }
