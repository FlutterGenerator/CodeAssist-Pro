 ...
 *
 * <ul>
 *   <li>{@link CompletionItem#setDocumentation(String)}
 *   <li>{@link CompletionItem#setAdditionalTextEdits(java.util.List)}
 *   <li>{@link CompletionItem#setDetail(String)}
 * </ul>
 *
...
public abstract class AbstractAttributeCompletionResolver extends AbstractCompletionResolver {
  ...
  @Override
  protected void resolveCompletionItem(
      DOMNode node,
   ...
   */
  protected abstract void resolveCompletionItem(
      DOMElement element,
      CompletionItem toResolve,
      ICompletionItemResolverRequest request,
      CancelChecker cancelChecker);
