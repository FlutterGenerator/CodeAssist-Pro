...
public interface ICodeActionParticipant {
  ...
  /**
   * Collect the code action in the given <code>codeActions</code> for the given code action request
   * <code>request</code>.
   *
   ...
   * @since 0.26
   */
  default void doCodeActionUnconditional(
      ICodeActionRequest request, List<CodeAction> codeActions, CancelChecker cancelChecker)
      throws CancellationException {}

  /**
   * Returns the codeAction resolver participant identified by the given <code>participantId</code>
   * and null otherwise.
   *
   * @param participantId the code action resolver participant ID.
   * @return the codeAction resolver participant identified by the given <code>participantId</code>
   *     and null otherwise.
   */
