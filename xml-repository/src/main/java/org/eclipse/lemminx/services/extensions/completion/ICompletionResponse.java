...
public interface ICompletionResponse {
  ...
  /**
   * Returns <code>true</code> if there are completion items coming from grammar and false
   * otherwise.
   *
   * @return <code>true</code> if there are completion items coming from grammar and false
   *     otherwise.
   */
