...
public interface IXMLDocumentProvider {
  ...
  /**
   * Returns the {@link DOMDocument} instance from the given <code>uri</code> and null otherwise.
   *
   * @param uri the document URI.
   * @return the {@link DOMDocument} instance from the given <code>uri</code> and null otherwise.
   */
