...
public interface IFormatterParticipant {
   ...
   *
   * <p>The formatter must take care of to generate attribute value with quote.
   *
   * @param name the attribute name.
   * @param valueWithoutQuote the attribute value without quote.
   * @param quote the quote and null otherwise. null quote means that the formatter must not
   *     generate a quote in the xml builder.
   ...
   */
  default boolean formatAttributeValue(
   ...
   * @return the format element category for the given DOM element and null otherwise.
   */
  default FormatElementCategory getFormatElementCategory(
      DOMElement element,
      XMLFormattingConstraints parentConstraints,
   ...
   * @param element the DOM element.
   * @param sharedSettings the shared settings.
   * @return true if the given element can be collapsed according to grammar constraints.
   */
