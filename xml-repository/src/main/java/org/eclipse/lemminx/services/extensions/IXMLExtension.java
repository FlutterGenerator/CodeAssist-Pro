...
public interface IXMLExtension {
  ...
  /**
   * Start method to register participants like {@link ICompletionParticipant}, {@link
   * IHoverParticipant}, {@link IDiagnosticsParticipant} in the given registry.
   *
   * @param params
   * @param registry
   * @param settings
  ...
  /**
   * Stop method to un-register participants like {@link ICompletionParticipant}, {@link
   * IHoverParticipant}, {@link IDiagnosticsParticipant} in the given registry.
   *
   * @param registry
   */
  ...
  /**
   * Called when the Settings or a Document have been saved. context.getType() can be used to
   * determine what type was saved. doSave is called on extension start up with a settings context
   * to provide the xml settings to the extension.
   *
   * @param context
   */
