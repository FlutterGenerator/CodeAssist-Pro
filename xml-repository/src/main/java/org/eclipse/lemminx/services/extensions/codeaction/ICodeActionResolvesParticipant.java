...
public interface ICodeActionResolvesParticipant {
  ...
  /**
   * Returns the resolved codeAction coming from the unresolved codeAction of the given <code>
   * request</code>.
   *
   * @param request the resolve code action request.
   * @param cancelChecker the cancel checker.
   * @return the resolved codeAction coming from the unresolved codeAction of the given <code>
   *     request</code>.
   */
