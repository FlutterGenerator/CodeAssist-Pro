...
public class XMLExtensionsRegistry implements IComponentProvider {
          ...
          .forEach(
              extension -> {
                try {
                  ...
                  LOGGER.log(
                      Level.SEVERE,
                      "Error while starting extension <" + extension.getClass().getName() + ">",
                      e);
                }
              });
    } else {
  ...
  void registerExtension(IXMLExtension extension) {
    try {
      ...
      LOGGER.log(
          Level.SEVERE,
          "Error while initializing extension <" + extension.getClass().getName() + ">",
          e);
    }
  }
  ...
  void unregisterExtension(IXMLExtension extension) {
    try {
      ...
      LOGGER.log(
          Level.SEVERE,
          "Error while stopping extension <" + extension.getClass().getName() + ">",
          e);
    }
  }
  ...
  public void unregisterDocumentColorParticipant(
      IDocumentColorParticipant documentColorParticipant) {
  ...
  public void registerTypeDefinitionParticipant(
      ITypeDefinitionParticipant typeDefinitionParticipant) {
    typeDefinitionParticipants.add(typeDefinitionParticipant);
  }

  public void unregisterTypeDefinitionParticipant(
      ITypeDefinitionParticipant typeDefinitionParticipant) {
  ...
  public void registerSymbolsProviderParticipant(
      ISymbolsProviderParticipant symbolsProviderParticipant) {
    symbolsProviderParticipants.add(symbolsProviderParticipant);
  }

  public void unregisterSymbolsProviderParticipant(
      ISymbolsProviderParticipant symbolsProviderParticipant) {
   ...
   * @since 0.14.2
   */
  public void registerWorkspaceServiceParticipant(
      IWorkspaceServiceParticipant workspaceServiceParticipant) {
   ...
   * @since 0.14.2
   */
  public void unregisterWorkspaceServiceParticipant(
      IWorkspaceServiceParticipant workspaceServiceParticipant) {
   ...
   * @since 0.18.0
   */
  public void registerDocumentLifecycleParticipant(
   ...
   * @since 0.18.0
   */
  public void unregisterDocumentLifecycleParticipant(
      IDocumentLifecycleParticipant documentLifecycleParticipant) {
