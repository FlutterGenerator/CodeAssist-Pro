...
public class LimitList<T> extends ArrayList<T> {
   ...
   *
   * <p>Throws a <code>ResultLimitExceededException</code> if <code>limit</code> becomes negative.
   *
  ...
  /**
   * Returns true if the symbols limit has been exceeded while computing symbols information, false
   * otherwise
   *
   * @return true if the symbols limit has been exceeded while computing symbols information, false
   *     otherwise
   */
