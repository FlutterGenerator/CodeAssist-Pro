...
public class SnippetContextUtils {
  ...
  /**
   * Returns true if the expression (with or without bracket) can be proceed according the
   * completion trigger and false otherwise.
   *
   * @param request the completion request.
   * @return true if the expression (with or without bracket) can be proceed according the
   *     completion trigger and false otherwise.
   */
