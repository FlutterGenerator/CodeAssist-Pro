...
public interface ICodeActionResolverRequest extends IBaseCodeActionRequest {
  ...
  /**
   * Returns the participant ID {@link ICodeActionResolvesParticipant} which must resolve the
   * unresolved code action.
   *
   * @return the participant ID {@link ICodeActionResolvesParticipant} which must resolve the
   *     unresolved code action.
   */
  String getParticipantId();

  /**
   * Returns the data property value of the given <code>fieldName</code> and null otherwise.
   *
   * @param fieldName the field name.
   * @return the data property value of the given <code>fieldName</code> and null otherwise.
   */
