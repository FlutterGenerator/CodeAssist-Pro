 ...
 *
 * <ul>
 *   <li>list of diagnostics.
 *   <li>list of completable future which are not done(ex : download some external resources XSD,
 *       DTD). This list of future gives the capability to refresh again the diagnostics once all
 *       completable futures are finished (ex : all download are finished).
 * </ul>
 *
 * @author Angelo ZERR
 */
public class DiagnosticsResult extends ArrayList<Diagnostic> {
  ...
  /**
   * Returns the completable futures used in a diagnostics (ex : completeable future to download
   * external resources XSD, DTD) and an empty list otherwise.
   *
   * @return the completable futures used in a diagnostics (ex : completeable future to download
   *     external resources XSD, DTD) and an empty list otherwise.
   */
