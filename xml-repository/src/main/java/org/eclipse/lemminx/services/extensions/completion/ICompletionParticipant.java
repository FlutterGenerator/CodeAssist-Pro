...
public interface ICompletionParticipant {
  ...
  void onTagOpen(
      ICompletionRequest completionRequest,
  ...
  /**
   * Collects and stores systemId completion items within the provided completion response <code>
   * response</code>
   *
  ...
  /**
   * Returns the completion item resolver that corresponds to the given participant id or null
   * otherwise.
   *
   * @param participantId the participant id to find the completion item resolver for
   * @return the completion item resolver that corresponds to the given participant id or null
   *     otherwise
   */
  default ICompletionItemResolveParticipant getResolveCompletionItemParticipant(
