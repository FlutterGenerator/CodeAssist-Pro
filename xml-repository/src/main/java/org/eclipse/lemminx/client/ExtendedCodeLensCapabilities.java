...
/**
 * Extended capabilities specific to the `textDocument/codeLens` request. This capability doesn't
 * belong to LSP specification. See proposal at
...
public class ExtendedCodeLensCapabilities extends DynamicRegistrationCapabilities {
  ...
  public ExtendedCodeLensCapabilities(
      final CodeLensKindCapabilities codeLensKind, final Boolean dynamicRegistration) {
    super(dynamicRegistration);
    this.codeLensKind = codeLensKind;
  }
