...
public class DOMDocumentType extends DTDDeclNode implements org.w3c.dom.DocumentType {
   ...
   *
   * <p>Since offset values are relative to 'this.start' we need to subtract getStart() to make them
   * relative to 'content'
   */
  ...
  /**
   * Returns the declaration parameter that represents the internal subset, or null if there is no
   * internal subset
   *
   * @return the declaration parameter that represents the internal subset, or null if there is no
   *     internal subset
   */
