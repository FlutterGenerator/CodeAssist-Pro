...
public class DOMProcessingInstruction extends DOMCharacterData
  ...
  /**
   * Returns the end tag start offset and {@link DOMNode#NULL_VALUE} if it doesn't exist.
   *
   * @return the end tag start offset and {@link DOMNode#NULL_VALUE} if it doesn't exist.
   */
