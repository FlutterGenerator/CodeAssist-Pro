...
public class DTDEntityDecl extends DTDDeclNode implements Entity {
   ...
   * Formats:
   *
   * <p><!ENTITY entity-name "entity-value">
   *
   * <p>or
   *
   * <p><!ENTITY % entity-name "entity-value">
   ...
   * <p>or
   *
   * <p><!ENTITY % entity-name SYSTEM "systemId">
   *
   * <p>or
   *
   * <p><!ENTITY % entity-name PUBLIC "publicId" "systemId">
   *
   * <p>or
   *
   * <p><!ENTITY % entity-name SYSTEM "systemId" NDATA name>
   *
   * <p>or
   *
   * <p><!ENTITY % entity-name PUBLIC "publicId" "systemId" NDATA name>
   */
