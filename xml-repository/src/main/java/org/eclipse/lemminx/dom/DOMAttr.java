...
public class DOMAttr extends DOMNode implements org.w3c.dom.Attr {
   ...
   *
   * <p>This will include quotations (", ').
   *
  ...
  public boolean valueContainsOffset(int offset) {
    return nodeAttrValue != null
        && offset >= nodeAttrValue.getStart()
        && offset < nodeAttrValue.getEnd();
  }
   ...
   *
   * @param attributeName
   * @return true if attribute name is the default xmlns attribute and false otherwise.
   */
   ...
   *
   * <p>If the URI doesnt match, null is returned.
   *
   * @param uri
   * @return
   */
   ...
   *
   * @param attributeName
   * @return true if attribute name is the no default xmlns attribute and false otherwise.
   */
