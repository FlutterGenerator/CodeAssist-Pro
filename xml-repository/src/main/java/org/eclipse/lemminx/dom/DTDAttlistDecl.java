...
public class DTDAttlistDecl extends DTDDeclNode {
   ...
   * Format:
   *
   * <p><!ATTLIST element-name attribute-name attribute-type "attribute-value>""
   *
   * <p>or
   *
   * <pre>
  ...
  private List<DTDAttlistDecl>
      internalChildren; // Holds all additional internal attlist declaractions
   ...
   *
   * <p>An ATTLIST decl can internally declare multiple declarations, see top of file. This will add
   * another one to its list of additional declarations.
   */
   ...
   *
   * <p>This is used because an Attlist declaration can have multiple attribute declarations within
   * a tag that are each represented by this class.
   */
