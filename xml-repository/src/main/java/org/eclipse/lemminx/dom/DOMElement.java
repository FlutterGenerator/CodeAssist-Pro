...
public class DOMElement extends DOMNode implements org.w3c.dom.Element {
  ...
  /**
   * Returns the offset after the start tag name. <code>
   * 	<foo| ></foo>
   * </code>
   *
  ...
  /**
   * Returns the DOM text node from the given <code>offset</code> and null otherwise.
   *
   * @param offset the offset.
   * @return the DOM text node from the given <code>offset</code> and null otherwise.
   */
