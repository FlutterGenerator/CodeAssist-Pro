...
public class DTDElementDecl extends DTDDeclNode {
  ...
  private static final Predicate<Character> isValidChar =
      (c) -> Character.isJavaIdentifierPart(c) || c == '-';

  /**
   * Formats:
   *
   * <p><!ELEMENT element-name category> or <!ELEMENT element-name (element-content)>
   */
   ...
   *
   * <p><!ELEMENT note (to,from,head|ing,body)> will return (start/end offset) of heading.
   *
   * <p><!ELEMENT n|ote (to,from,heading,body)> will return null.
   *
   * @param offset the offset
   * @return the parameter (start/end offset) at the given offset and null otherwise.
   */
  ...
  public void collectParameters(
      DTDDeclParameter target, BiConsumer<DTDDeclParameter, DTDDeclParameter> collector) {
  ...
  /**
   * Returns true if the word in the given <code>text</code> which starts at <code>wordStart</code>
   * offset and ends at <code>wordEnd</code> matches the given <code>searchWord</code>
   *
   * @param searchWord the word to search
   * @param text the text
   * @param wordStart the word start offset
   * @param wordEnd the word end offset
   * @return true if the word in the given <code>text</code> which starts at <code>wordStart</code>
   *     offset and ends at <code>wordEnd</code> matches the given <code>searchName</code>
   */
