...
public class ResolvedURIInfo {
  ...
  /**
   * Returns the resolver name {@link URIResolverExtension#getName()} (ex : 'default', 'file
   * association) used to resolve the URI.
   *
   * @return the resolver name {@link URIResolverExtension#getName()} (ex : 'default', 'file
   *     association) used to resolve the URI.
   */
