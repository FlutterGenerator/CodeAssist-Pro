...
public class CacheResourceDownloadedException extends CacheResourceException {
  ...
  public CacheResourceDownloadedException(
      String resourceURI, Path resourceCachePath, String cause, Throwable e) {
    this(
        resourceURI,
        resourceCachePath,
        cause,
        CacheResourceDownloadedError.ERROR_WHILE_DOWNLOADING,
        e);
  }
  ...
  public CacheResourceDownloadedException(
      ...
      String cause,
      CacheResourceDownloadedError errorCode,
      Throwable e) {
