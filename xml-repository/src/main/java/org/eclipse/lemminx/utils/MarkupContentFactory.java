...
public class MarkupContentFactory {
   ...
   * @return the markup content according the given markup kind and the capability of the client.
   */
  public static MarkupContent createMarkupContent(
      String value, String preferredKind, ISharedSettingsRequest support) {
    if (value == null) {
      return null;
    }
