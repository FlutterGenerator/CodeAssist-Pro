...
public class StringUtils {
  ...
  /**
   * Returns the start word offset from the left of the given <code>offset</code> to the given
   * <code>min</code> and -1 if no word.
   *
   * @param text the text
   * @param offset the offset
   * @param min the minimum left offset.
   * @param isValidChar predicate to check if current character belong to the word.
   * @return the start word offset from the left of the given <code>offset</code> to the given
   *     <code>min</code> and -1 if no word.
   */
  public static int findStartWord(
      String text, int offset, int min, Predicate<Character> isValidChar) {
  ...
  /**
   * Returns the end word offset from the right of the given <code>offset</code> to the given <code>
   * max</code> and -1 if no word.
   *
   * @param text the text
   * @param offset the offset
   * @param isValidChar predicate to check if current character belong to the word.
   ...
   *     word.
   */
  public static int findEndWord(
      String text, int offset, int max, Predicate<Character> isValidChar) {
