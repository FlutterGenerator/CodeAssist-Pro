...
public class XMLTextDocumentService implements TextDocumentService {
      ...
      documents.all().stream()
          .forEach(
              document -> {
                ...
                if (xmlDocument != null
                    && !documentsToValidate.contains(document)
  ...
  public XMLTextDocumentService(XMLLanguageServer xmlLanguageServer) {
    ...
    this.documents =
        new ModelTextDocuments<DOMDocument>(
    ...
    this.xmlValidatorDelayer =
        new ModelValidatorDelayer<DOMDocument>(
            (document) -> {
              DOMDocument xmlDocument = document.getModel();
                  ...
                  .forEach(
                      participant -> {
                        try {
                          ...
                          LOGGER.log(
                              Level.SEVERE,
                              "Error while processing didChange for the participant '"
  ...
  public void updateClientCapabilities(
      ClientCapabilities capabilities, ExtendedClientCapabilities extendedClientCapabilities) {
    if (capabilities != null) {
      ...
      if (textDocumentClientCapabilities != null) {
        sharedSettings
            ...
            .setCapabilities(textDocumentClientCapabilities.getCompletion());
        sharedSettings
            .getCodeActionSettings()
            .setCapabilities(textDocumentClientCapabilities.getCodeAction());
        sharedSettings
            .getFoldingSettings()
            .setCapabilities(textDocumentClientCapabilities.getFoldingRange());
        sharedSettings
            .getHoverSettings()
            .setCapabilities(textDocumentClientCapabilities.getHover());
        sharedSettings
            .getValidationSettings()
            .setCapabilities(textDocumentClientCapabilities.getPublishDiagnostics());
        codeActionLiteralSupport =
            textDocumentClientCapabilities.getCodeAction() != null
                && textDocumentClientCapabilities.getCodeAction().getCodeActionLiteralSupport()
                    != null;
        hierarchicalDocumentSymbolSupport =
            textDocumentClientCapabilities.getDocumentSymbol() != null
        ...
        definitionLinkSupport =
            textDocumentClientCapabilities.getDefinition() != null
        ...
        typeDefinitionLinkSupport =
            textDocumentClientCapabilities.getTypeDefinition() != null
    ...
    if (extendedClientCapabilities != null) {
      ...
      sharedSettings.setActionableNotificationSupport(
          extendedClientCapabilities.isActionableNotificationSupport());
      sharedSettings.setOpenSettingsCommandSupport(
          extendedClientCapabilities.isOpenSettingsCommandSupport());
  ...
  public CompletableFuture<Either<List<CompletionItem>, CompletionList>> completion(
    ...
    return computeDOMAsync(
        params.getTextDocument(),
        (xmlDocument, cancelChecker) -> {
          CompletionList list =
              getXMLLanguageService()
                  .doComplete(xmlDocument, params.getPosition(), sharedSettings, cancelChecker);
    ...
    return computeDOMAsync(
        ...
        (xmlDocument, cancelChecker) -> {
          return getXMLLanguageService()
              .resolveCompletionItem(unresolved, xmlDocument, sharedSettings, cancelChecker);
        });
  }
  ...
  public CompletableFuture<Hover> hover(HoverParams params) {
    return computeDOMAsync(
        ...
        (xmlDocument, cancelChecker) -> {
          return getXMLLanguageService()
              .doHover(xmlDocument, params.getPosition(), sharedSettings, cancelChecker);
        });
  }
  ...
  public CompletableFuture<List<? extends DocumentHighlight>> documentHighlight(
    ...
    return computeDOMAsync(
        ...
        (xmlDocument, cancelChecker) -> {
          return getXMLLanguageService()
              .findDocumentHighlights(xmlDocument, params.getPosition(), cancelChecker);
        });
  }
        ...
        (xmlDocument, cancelChecker) -> {
          ...
          if (hierarchicalDocumentSymbolSupport) {
            DocumentSymbolsResult result =
                getXMLLanguageService()
                    .findDocumentSymbols(xmlDocument, symbolSettings, cancelChecker);
            ...
            SymbolInformationResult result =
                getXMLLanguageService()
          ...
          if (resultLimitExceeded) {
            ...
            getLimitExceededWarner()
                .onResultLimitExceeded(
                    xmlDocument.getTextDocument().getUri(), LimitFeature.SYMBOLS);
          }
          return symbols;
        });
  }
    ...
    return computeDOMAsync(
        ...
        (xmlDocument, cancelChecker) -> {
          CompositeSettings settings =
              new CompositeSettings(getSharedSettings(), params.getOptions());
  ...
  public CompletableFuture<Either3<Range, PrepareRenameResult, PrepareRenameDefaultBehavior>>
    ...
    return computeDOMAsync(
        params.getTextDocument(),
        (xmlDocument, cancelChecker) -> {
          Either<Range, PrepareRenameResult> either =
              getXMLLanguageService()
                  .prepareRename(xmlDocument, params.getPosition(), cancelChecker);
          if (either != null) {
            if (either.isLeft()) {
  ...
  public CompletableFuture<WorkspaceEdit> rename(RenameParams params) {
    return computeDOMAsync(
        ...
        (xmlDocument, cancelChecker) -> {
          return getXMLLanguageService()
              .doRename(xmlDocument, params.getPosition(), params.getNewName(), cancelChecker);
        });
  }
          ...
          .forEach(
              participant -> {
                try {
                  ...
                  LOGGER.log(
                      Level.SEVERE,
                      "Error while processing didClose for the participant '"
                          + participant.getClass().getName()
                          + "'.",
                      e);
                }
  ...
  public CompletableFuture<List<FoldingRange>> foldingRange(FoldingRangeRequestParams params) {
    return computeDOMAsync(
        ...
        (xmlDocument, cancelChecker) -> {
          return getXMLLanguageService()
              .getFoldingRanges(xmlDocument, sharedSettings.getFoldingSettings(), cancelChecker);
        });
  }
  ...
  public CompletableFuture<List<? extends Location>> references(ReferenceParams params) {
    return computeDOMAsync(
        ...
        (xmlDocument, cancelChecker) -> {
          return getXMLLanguageService()
              .findReferences(
                  xmlDocument, params.getPosition(), params.getContext(), cancelChecker);
        });
  }
  ...
  public CompletableFuture<List<? extends CodeLens>> codeLens(CodeLensParams params) {
    ...
    return computeDOMAsync(
        ...
        (xmlDocument, cancelChecker) -> {
          return getXMLLanguageService()
              .getCodeLens(xmlDocument, sharedSettings.getCodeLensSettings(), cancelChecker);
        });
  }
  ...
  public CompletableFuture<List<Either<Command, CodeAction>>> codeAction(CodeActionParams params) {
    ...
    return computeDOMAsync(
        ...
        (xmlDocument, cancelChecker) -> {
          ...
          return (List<Either<Command, CodeAction>>)
              getXMLLanguageService()
                  .doCodeActions(
                      params.getContext(),
                      params.getRange(),
                  ...
                  .map(
                      ca -> {
                        if (codeActionLiteralSupport) {
                          ...
                          Command command =
                              new Command(ca.getTitle(), "_xml.applyCodeAction", arguments);
  ...
  public CompletableFuture<CodeAction> resolveCodeAction(CodeAction unresolved) {
    return computeDOMAsync(
        ...
        (xmlDocument, cancelChecker) -> {
          return getXMLLanguageService()
              .resolveCodeAction(unresolved, xmlDocument, sharedSettings, cancelChecker);
        });
  }

  /**
   * Returns the indentation settings (`xml.format.tabSize` and `xml.format.insertSpaces`) for the
   * document with the given URI.
   *
   * @param uri the uri of the document to get the indentation settings for
   * @return the indentation settings (`xml.format.tabSize` and `xml.format.insertSpaces`) for the
   *     document with the given URI
   */
  private XMLFormattingOptions getIndentationSettings(@NonNull String uri) {
    ...
    try {
      List<Object> indentationSettings =
          xmlLanguageServer
              .getLanguageClient()
              .configuration(
      ...
      LOGGER.log(
          Level.SEVERE,
          "Error while processing getting indentation settings for code actions'.",
          e);
    }
    return newOptions;
  }
  ...
  public CompletableFuture<List<SelectionRange>> selectionRange(SelectionRangeParams params) {
    return computeDOMAsync(
        ...
        (xmlDocument, cancelChecker) -> {
          return getXMLLanguageService()
              .getSelectionRanges(xmlDocument, params.getPositions(), cancelChecker);
        });
  }
  ...
  public CompletableFuture<LinkedEditingRanges> linkedEditingRange(
    ...
    return computeDOMAsync(
        ...
        (xmlDocument, cancelChecker) -> {
          return getXMLLanguageService()
              .findLinkedEditingRanges(xmlDocument, params.getPosition(), cancelChecker);
        });
  }
                ...
                .forEach(
                    participant -> {
                      try {
                        ...
                        LOGGER.log(
                            Level.SEVERE,
                            "Error while processing didSave for the participant '"
                                + participant.getClass().getName()
                                + "'.",
                            e);
                      }
  ...
  private void triggerValidationFor(
   ...
   * @throws CancellationException when the DOM document content changed and diagnostics must be
   *     stopped.
   */
                ...
                .forEach(
                    participant -> {
                      try {
                        ...
                        LOGGER.log(
                            Level.SEVERE,
                            "Error while processing didOpen for the participant '"
                                + participant.getClass().getName()
                                + "'.",
                            e);
                      }
  ...
  private <R> CompletableFuture<R> computeDOMAsync(
      Object data, BiFunction<DOMDocument, CancelChecker, R> code) {
   ...
   * @param code a bi function that accepts a {@link CancelChecker} and parsed {@link DOMDocument}
   *     and returns the to be computed value
   * @return the DOM Document for a given uri in a future and then apply the given function.
   */
  public <R> CompletableFuture<R> computeDOMAsync(
      TextDocumentIdentifier documentIdentifier, BiFunction<DOMDocument, CancelChecker, R> code) {
