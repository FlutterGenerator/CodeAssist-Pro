...
public class TextDocuments<T extends TextDocument> {
   ...
   *
   * @return true if text document is managed in incremental mode and false otherwise.
   */
  ...
  /**
   * Returns the document for the given URI. Returns undefined if the document is not mananged by
   * this instance.
   *
