...
public class ModelTextDocuments<T> extends TextDocuments<ModelTextDocument<T>> {
   ...
   * @param code a bi function that accepts the parsedmodel and {@link CancelChecker} and returns
   *     the to be computed value
   * @return the DOM Document for a given uri in a future and then apply the given function.
   */
  public <R> CompletableFuture<R> computeModelAsync(
      TextDocumentIdentifier documentIdentifier, BiFunction<T, CancelChecker, R> code) {
   ...
   * @param code a bi function that accepts the parsed model and {@link CancelChecker} and returns
   *     as future the to be computed value
   * @return the model for a given uri in a future and then apply the given function.
   */
  public <R> CompletableFuture<R> computeModelAsyncCompose(
  ...
  private static <R> CompletableFuture<R> computeAsyncCompose(
