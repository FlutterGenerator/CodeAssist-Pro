...
public class CodeActionFactory {
   ...
   * @return
   */
  public static CodeAction remove(
      String title, Range range, TextDocumentItem document, Diagnostic diagnostic) {
   ...
   */
  public static CodeAction insert(
      String title,
      Position position,
      String insertText,
    ...
    WorkspaceEdit workspaceEdit =
        new WorkspaceEdit(Collections.singletonList(Either.forLeft(textDocumentEdit)));
   ...
   */
  public static TextDocumentEdit insertEdit(
      String insertText, Position position, TextDocumentItem document) {
  ...
  public static CodeAction replace(
      String title, List<TextEdit> replace, TextDocumentItem document, Diagnostic diagnostic) {
    ...
    TextDocumentEdit textDocumentEdit =
        new TextDocumentEdit(versionedTextDocumentIdentifier, replace);
    WorkspaceEdit workspaceEdit =
        new WorkspaceEdit(Collections.singletonList(Either.forLeft(textDocumentEdit)));
    insertContentAction.setEdit(workspaceEdit);
    return insertContentAction;
   ...
   */
  public static WorkspaceEdit getReplaceWorkspaceEdit(
      String replaceText, Range range, TextDocumentItem document) {
    TextEdit replace = new TextEdit(range, replaceText);
    VersionedTextDocumentIdentifier versionedTextDocumentIdentifier =
        new VersionedTextDocumentIdentifier(document.getUri(), document.getVersion());
    TextDocumentEdit textDocumentEdit =
        new TextDocumentEdit(versionedTextDocumentIdentifier, Collections.singletonList(replace));
    return new WorkspaceEdit(Collections.singletonList(Either.forLeft(textDocumentEdit)));
  }

  public static CodeAction replaceAt(
      String title,
      String replaceText,
      TextDocumentItem document,
      Diagnostic diagnostic,
    ...
    TextDocumentEdit textDocumentEdit =
        new TextDocumentEdit(versionedTextDocumentIdentifier, edits);
    WorkspaceEdit workspaceEdit =
        new WorkspaceEdit(Collections.singletonList(Either.forLeft(textDocumentEdit)));
   ...
   */
  public static CodeAction createFile(
      String title, String fileURI, String fileContent, Diagnostic diagnostic) {
  ...
  /**
   * Returns the file edit to create the file with the given <code>fileURI</code> and the given
   * <code>fileContent</code>.
   *
   * @param fileURI the file URI to create.
   * @param fileContent the file content.
   * @return the file edit to create the file with the given <code>fileURI</code> and the given
   *     <code>fileContent</code>.
   */
  public static WorkspaceEdit createFileEdit(String fileURI, String fileContent) {
    ...
    actionsToTake.add(
        Either.forLeft(new TextDocumentEdit(identifier, Collections.singletonList(te))));
   ...
   * @param diagnostic The diagnostic that this CodeAction will fix
   */
  public static CodeAction createCommand(
      String title, String commandId, List<Object> commandParams, Diagnostic diagnostic) {
    CodeAction codeAction = new CodeAction(title);
