...
public class XSDURIResolverExtension implements URIResolverExtension {
  ...
  private static final String SCHEMA_FOR_SCHEMA_URI_2001 =
      "http://www.w3.org/2001/XMLSchema"; //$NON-NLS-1$

  private static final List<ResourceToDeploy> SCHEMA_URI_2001_RESOURCES =
      Arrays.asList(
          ...
          new ResourceToDeploy(
              "http://www.w3.org/2001/datatypes.dtd", "schemas/xsd/datatypes.dtd"));

  /** The Namespace namespace URI (= http://www.w3.org/XML/1998/namespace) */
  private static final String SCHEMA_FOR_NAMESPACE_URI_1998 =
      "http://www.w3.org/XML/1998/namespace"; //$NON-NLS-1$

  private static final ResourceToDeploy NAMESPACE_URI_1998_RESOURCE =
      new ResourceToDeploy("https://www.w3.org/2001/xml.xsd", "schemas/xsd/xml.xsd");
  ...
  public String resolve(String baseLocation, String publicId, String systemId) {
    if (SCHEMA_FOR_SCHEMA_URI_2001.equals(publicId)) {
      ...
      try {
        return CacheResourcesManager.getResourceCachePath(NAMESPACE_URI_1998_RESOURCE)
            .toFile()
            .toURI()
            .toString();
      } catch (Exception e) {
  ...
  public XMLInputSource resolveEntity(XMLResourceIdentifier resourceIdentifier)
    ...
    if (SCHEMA_FOR_SCHEMA_URI_2001.equals(publicId)
        || SCHEMA_FOR_NAMESPACE_URI_1998.equals(publicId)) {
