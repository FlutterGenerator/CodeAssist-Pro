...
public class LSPErrorReporterForXSD extends AbstractReferencedGrammarLSPErrorReporter {
  ...
  protected Range toLSPRange(
    ...
    if (xsdCode != null) {
      if (errorForDocument
          || XSDErrorCode.src_import_1_2.equals(xsdCode)
          || XSDErrorCode.src_import_3_1.equals(xsdCode)
          || XSDErrorCode.src_import_3_2.equals(xsdCode)) {
