...
public class ContentModelSettings {
   ...
   *
   * @return true if cache to download XML Schema, DTD must be activated and false otherwise.
   */
  ...
  /**
   * Returns file associations list between a file name pattern (glob) and an XML Schema file, DTD
   * (system Id).
   *
   * @return file associations list between a file name pattern (glob) and an XML Schema file, DTD
   *     (system Id).
   */
  ...
  public static ContentModelSettings getContentModelXMLSettings(
  ...
  public void setDownloadExternalResources(
