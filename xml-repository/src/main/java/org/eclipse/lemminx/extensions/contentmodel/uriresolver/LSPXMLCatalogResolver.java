...
class LSPXMLCatalogResolver extends XMLCatalogResolver {
  ...
  /**
   * Returns true if it's an XSD include/import with namespace and false otherwise.
   *
   * @param resourceIdentifier the resource identifier.
   * @return true if it's an XSD include/import with namespace and false otherwise.
   */
  private static boolean isXSDIncludeWithNamespace(XMLResourceIdentifier resourceIdentifier) {
    String namespaceURI = resourceIdentifier.getNamespace();
    if (resourceIdentifier != null
        && resourceIdentifier instanceof XSDDescription
        && namespaceURI != null
