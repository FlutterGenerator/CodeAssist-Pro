 ...
 *
 * <ul>
 *   <li>[BUG 2]: when Xerces XML grammar pool is used, the second validation ignore the existing of
 *       entities. See https://github.com/redhat-developer/vscode-xml/issues/234
 * </ul>
 *
 * @author Angelo ZERR
 */
public class LSPSAXParser extends SAXParser {
  ...
  public void doctypeDecl(String rootElement, String publicId, String systemId, Augmentations augs)
    ...
    if (systemId != null && grammarPool != null) {
      ...
      XMLEntityManager entityManager =
          (XMLEntityManager) fConfiguration.getProperty(ENTITY_MANAGER);
      XMLDTDDescription grammarDesc = createGrammarDescription(rootElement, publicId, systemId);
   ...
   */
  private XMLDTDDescription createGrammarDescription(
      String rootElement, String publicId, String systemId) {
    String eid = null;
    try {
    ...
    return new XMLDTDDescription(
        publicId, systemId, locator.getExpandedSystemId(), eid, rootElement);
  }
   ...
   * @param entityManager the entitymanager to update with entities of the DTD grammar.
   */
