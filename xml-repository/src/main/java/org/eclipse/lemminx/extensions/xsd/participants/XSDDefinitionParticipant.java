 ...
 *
 * <ul>
 *   <li>xs:element/@type -> xs:complexType/@name
 *   <li>xs:extension/@base -> xs:complexType/@name
 *   <li>xs:element/@ref -> xs:complexType/@name
 * </ul>
 *
 * @author Angelo ZERR
 */
public class XSDDefinitionParticipant extends AbstractDefinitionParticipant {
  ...
  @Override
  protected void doFindDefinition(
      IDefinitionRequest request, List<LocationLink> locations, CancelChecker cancelChecker) {
          ...
          (targetNamespacePrefix, targetAttr) -> {
            LocationLink location =
                XMLPositionUtility.createLocationLink(
                    attr.getNodeAttrValue(), targetAttr.getNodeAttrValue());
