...
/**
 * XML Stylesheet file path support for *.xsl to provide completion for attributes :
 *
 * <ul>
 *   <li>include/@href
 *   <li>import/@href
...
public class XSLFilePathSupportParticipant implements IFilePathSupportParticipant {
  ...
  static {
    XSL_FILE_PATH_EXPRESSIONS =
        Arrays.asList(
            new XSLFilePathExpression("include/@href"), new XSLFilePathExpression("import/@href"));
  }
