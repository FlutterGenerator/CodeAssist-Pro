...
/**
 * Content model document which abstracts element declaration from a given grammar (XML Schema,
 * DTD).
 */
public interface CMDocument {
   ...
   *
   * @param namespaceURI
   * @return true if the model document defines the given namespace and false otherwise.
   */
