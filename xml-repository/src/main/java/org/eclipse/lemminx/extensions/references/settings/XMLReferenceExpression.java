...
public class XMLReferenceExpression {
  ...
  /**
   * Returns true if the given DOM Node match the XPath expression of the 'from' XPath matcher and
   * false otherwise.
   *
   * @param node the DOM Node to match.
   * @return true if the given DOM Node match the XPath expression of the 'from' XPath matcher and
   *     false otherwise.
   */
  ...
  /**
   * Returns true if the given DOM Node match the XPath expression of the 'to' XPath matcher and
   * false otherwise.
   *
   * @param node the DOM Node to match.
   * @return true if the given DOM Node match the XPath expression of the 'to' XPath matcher and
   *     false otherwise.
   */
