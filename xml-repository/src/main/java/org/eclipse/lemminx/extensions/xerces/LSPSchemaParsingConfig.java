...
/**
 * The Xerces {@link SchemaParsingConfig} doesn't give the capability to customize the XML entity
 * manager.
 *
 * <p>This class extends {@link SchemaParsingConfig} and customizes the XML entity manager with the
