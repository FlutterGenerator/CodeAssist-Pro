...
public class EntitiesDefinitionParticipant extends AbstractDefinitionParticipant {
   ...
   */
  private static void searchInLocalEntities(
      String entityName,
      Range entityRange,
   ...
   * @param cancelChecker the cancel checker.
   */
  private static void searchInExternalEntities(
      String entityName,
      Range entityRange,
      DOMDocument document,
      List<LocationLink> locations,
      IDefinitionRequest request,
      CancelChecker cancelChecker) {
  ...
  private static void fillEntityLocation(
      DTDEntityDecl entity, String entityName, Range entityRange, List<LocationLink> locations) {
