...
/**
 * Base class of the code action resolver participant used to generate the missing grammar (DTD /
 * XSD) which is declared in the XML as association (ex : via xsi:noNamespaceSchemaLocation)
 *
 * @author Angelo ZERR
 */
public abstract class AbstractGenerateGrammarCodeActionResolver
   ...
   *
   * @return the grammar settings used to generate the missing grammar file (XSD, DTD).
   */
