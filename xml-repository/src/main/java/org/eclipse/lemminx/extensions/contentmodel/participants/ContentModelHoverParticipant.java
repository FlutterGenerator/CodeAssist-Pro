...
public class ContentModelHoverParticipant extends HoverParticipantAdapter {
  ...
  public Hover onTag(IHoverRequest hoverRequest, CancelChecker cancelChecker) throws Exception {
    try {
      ContentModelManager contentModelManager =
          hoverRequest.getComponent(ContentModelManager.class);
  ...
  @Override
  public Hover onAttributeName(IHoverRequest hoverRequest, CancelChecker cancelChecker)
      throws Exception {
        ...
        if (cmElement != null) {
          ...
          if (cmAttribute != null) {
            MarkupContent content =
                XMLGenerator.createMarkupContent(cmAttribute, cmElement, hoverRequest);
            fillHoverContent(content, contentValues);
          }
        }
      }
  ...
  @Override
  public Hover onAttributeValue(IHoverRequest hoverRequest, CancelChecker cancelChecker)
      throws Exception {
    DOMAttr attribute = (DOMAttr) hoverRequest.getNode();
    ...
    try {
      ...
      for (CMDocument cmDocument : cmDocuments) {
        ...
        if (cmElement != null) {
          ...
          if (cmAttribute != null) {
            MarkupContent content =
                XMLGenerator.createMarkupContent(
                    cmAttribute, attributeValue, cmElement, hoverRequest);
            fillHoverContent(content, contentValues);
          }
        }
      }
  ...
  public Hover onText(IHoverRequest hoverRequest, CancelChecker cancelChecker) throws Exception {
    ...
    try {
      ...
      for (CMDocument cmDocument : cmDocuments) {
        ...
        if (cmElement != null) {
          MarkupContent content =
              XMLGenerator.createMarkupContent(cmElement, textContent, hoverRequest);
          fillHoverContent(content, contentValues);
        }
      }
      return createHover(contentValues);
  ...
  private static Hover getCacheWarningHover(
      CacheResourceDownloadingException e, ISharedSettingsRequest support) {
    // Here cache is enabled and some XML Schema, DTD, etc are loading
    MarkupContent content =
        MarkupContentFactory.createMarkupContent(
