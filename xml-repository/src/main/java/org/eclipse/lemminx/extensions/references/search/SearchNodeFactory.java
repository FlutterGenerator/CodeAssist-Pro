...
public class SearchNodeFactory {
  ...
  private static final Predicate<Character> NAME_PREDICATE =
      ch -> {
   ...
   * <p><code>
   * 	<link target="#abc #def" >
   * </code> will return the search nodes #abc and #def.
   *
   ...
   */
  public static List<SearchNode> findSearchNodes(
      DOMNode node, String prefix, boolean multiple, Direction direction) {
  ...
  /**
   * Returns the search node in the given DOM <code>node</code> at the given <code>offset</code> and
   * null otherwise.
   *
   * <p><code>
   * 	<link target="#abc #de|f" >
   * </code> will return the search node #def.
   *
   * @param node the DOM node.
   ...
   * @param multiple true if multiple is supported.
   * @param direction the search node direction.
   * @return the search node in the given DOM <code>node</code> at the given <code>offset</code> and
   *     null otherwise.
   */
  public static SearchNode getSearchNodeAt(
      DOMNode node, int offset, String prefix, boolean multiple, Direction direction) {
    int startNode = getStartNode(node);
    if (startNode == -1) {
      return null;
    }
