...
/**
 * URI resolver which, on the first access, downloads the XML Schema or DTD from "http(s)" or "ftp"
 * URIs to the file system. On subsequent calls, the locally cached file is used instead of being
 * remotely accessed. This cache drastically improves the resolution performance of some XML Schemas
 * (ex: xml.xsd)
 */
