...
/**
 * The Xerces {@link XML11DTDProcessor} doesn't give the capability to customize the XML entity
 * manager.
 *
 * <p>This class extends {@link XML11DTDProcessor} and customizes the XML entity manager with the
 * {@link LSPXMLEntityManager} which handles the remote resource download errors.
 *
 * @author Angelo ZERR
 */
public class LSPXML11DTDProcessor extends XML11DTDProcessor {

  public LSPXML11DTDProcessor(
    ...
    fEntityManager.setProperty(
        Constants.XERCES_PROPERTY_PREFIX + Constants.ERROR_REPORTER_PROPERTY, errorReporter);
