...
public class CMXSDAttributeDeclaration implements CMAttributeDeclaration {
  ...
  /**
   * Returns list of xs:annotation from the attribute declaration or type declaration.
   *
   * @return list of xs:annotation from the attribute declaration or type declaration.
   */
   ...
   * Returns list of xs:annotation from the attribute declaration or type declaration.
   *
   * <p>Indicated by: https://msdn.microsoft.com/en-us/library/ms256143(v=vs.110).aspx xs:attribute
