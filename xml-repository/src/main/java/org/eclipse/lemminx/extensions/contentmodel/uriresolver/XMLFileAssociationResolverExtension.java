...
public class XMLFileAssociationResolverExtension
  ...
  private static Logger LOGGER =
      Logger.getLogger(XMLFileAssociationResolverExtension.class.getName());
      ...
      for (XMLFileAssociation fileAssociation : fileAssociations) {
        ...
        try {
          String expandSystemId =
              XMLEntityManager.expandSystemId(fileAssociation.getSystemId(), rootUri, false);
          ...
          LOGGER.log(
              Level.WARNING,
              "Issue expanding the provided systemId from the file associations.",
              e);
        }
      }
    }
