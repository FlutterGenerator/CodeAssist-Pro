...
public class XMLModelUtils {
  ...
  /**
   * Returns the DOM range of the href of the xml-model processing instruction which matches the
   * given hrefLocation.
   *
   * @param document the DOM document.
   * @param hrefLocation the href location.
   * @return the DOM range of the href of the xml-model processing instruction which matches the
   *     given hrefLocation.
   */
