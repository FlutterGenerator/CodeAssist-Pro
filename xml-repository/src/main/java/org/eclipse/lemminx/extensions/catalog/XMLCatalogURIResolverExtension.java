...
public class XMLCatalogURIResolverExtension implements URIResolverExtension {
   ...
   */
  private static final String CATALOG_NAMESPACE_URI =
      "urn:oasis:names:tc:entity:xmlns:xml:catalog"; //$NON-NLS-1$

  private static final String CATALOG_SYSTEM =
      "http://www.oasis-open.org/committees/entity/release/1.1/catalog.xsd";

  private static final ResourceToDeploy CATALOG_RESOURCE =
      new ResourceToDeploy(CATALOG_SYSTEM, "schemas/catalog/catalog-1.1.xsd");
  ...
  public String resolve(String baseLocation, String publicId, String systemId) {
    ...
    try {
      return CacheResourcesManager.getResourceCachePath(CATALOG_RESOURCE)
          .toFile()
          .toURI()
          .toString();
    } catch (Exception e) {
