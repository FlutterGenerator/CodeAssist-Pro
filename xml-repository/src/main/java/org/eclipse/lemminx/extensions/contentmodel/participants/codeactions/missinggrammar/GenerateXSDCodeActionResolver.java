...
/**
 * Code action resolver participant to generate the missing XSD which is declared in the XML as
 * association via xsi:noNamespaceSchemaLocation or xml-model.
 *
 * @author Angelo ZERR
 */
