 ...
 *
 * <p>This class is a copy/paste of {@link
 * org.apache.xerces.util.XMLGrammarPoolImpl.XMLGrammarPoolImpl} from Xerces adapated to use
 * .lemminx cache.
 *
...
public class LSPXMLGrammarPool implements XMLGrammarPool {
  ...
  /**
   * Update the DTD internal subset entry for the given XML DTD description and return true if the
   * cached DTD grammar internal subset is equal to the given internal subset and false otherwise.
   *
   * @param desc the XML DTD description.
   * @param internalSubset the internal subset.
   * @return true if the cached DTD grammar internal subset is equal to the given internal subset
   *     and false otherwise.
   */
