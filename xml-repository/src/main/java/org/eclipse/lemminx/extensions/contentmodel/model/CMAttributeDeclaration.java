...
/**
 * Content model element which abstracts attribute declaration from a given grammar (XML Schema,
 * DTD, RelaxNG).
 */
public interface CMAttributeDeclaration {
  ...
  /**
   * Returns the declared attribute name with the proper prefix mapped with the attribute namespace
   * and the local name otherwise.
   *
   * @param prefixes map which contains namespace as key and prefix as value.
   * @return the declared attribute name with the proper prefix mapped with the attribute namespace
   *     and the local name otherwise.
   */
  default String getName(Map<String /* namespaceURI */, String /* prefix */> prefixes) {
    String namespace = getNamespace();
    String prefix =
        StringUtils.isEmpty(namespace) ? null : (prefixes != null ? prefixes.get(namespace) : null);
   ...
   *
   * @return enumeration values of the declared attribute and empty collection otherwise.
   */
   ...
   * @return formatted documentation of the declared attribute according to settings defined in
   *     <code>request</code>
   */
  String getAttributeNameDocumentation(ISharedSettingsRequest request);

  /**
   * Returns formatted documentation about <code>value</code>, according to settings defined in
   * <code>request</code>
   *
   * @param value the attribute value to find documentation for
   * @param request the request containing settings
   * @return formatted documentation about <code>value</code>, according to settings defined in
   *     <code>request</code>
   */
