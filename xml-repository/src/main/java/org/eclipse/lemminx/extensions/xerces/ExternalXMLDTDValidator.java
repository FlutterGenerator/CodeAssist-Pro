...
/**
 * Xerces uses {@link XMLDTDValidator} which gets the DOCTYPE dtd file from the declared DOCTYPE.
 *
 * <p>This class extends {@link XMLDTDValidator} to set the DOCTYPE dtd file with {@link
 * ExternalXMLDTDValidator#setExternalDoctype(String)}
 */
public class ExternalXMLDTDValidator extends XMLDTDValidator {

  public static final String DOCTYPE =
      "http://apache.org/xml/properties/dtd/external-doctype"; //$NON-NLS-1$ ;
    ...
    if (rootElement) {
      ...
      if (fValidation) {
        ...
        try {
          eid =
              XMLEntityManager.expandSystemId(
                  externalDoctype, locator.getExpandedSystemId(), false);
        } catch (java.io.IOException e) {
        }
        XMLDTDDescription grammarDesc =
            new XMLDTDDescription(
                null, externalDoctype, locator.getExpandedSystemId(), eid, rootElementName);
        ...
        if (fDTDGrammar == null || !isImmutable(fDTDGrammar)) {
          ...
          loader.setProperty(
              "http://apache.org/xml/properties/internal/error-reporter", reporterForGrammar);
          ...
          try {
            ...
            fErrorReporter.reportError(
                locator,
                XMLModelMessageFormatter.XML_MODEL_DOMAIN,
                DTD_NOT_FOUND_KEY,
                new Object[] {element, eid},
  ...
  public void reset(XMLComponentManager componentManager) throws XMLConfigurationException {
    ...
    reporterForGrammar =
        (XMLErrorReporter) componentManager.getProperty(ERROR_REPORTER_FOR_GRAMMAR);
    fValidation = false;
