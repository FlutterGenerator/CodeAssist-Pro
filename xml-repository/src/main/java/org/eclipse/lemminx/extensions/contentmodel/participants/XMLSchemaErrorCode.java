...
public enum XMLSchemaErrorCode implements IXMLErrorCode {
  cvc_complex_type_2_3(
      "cvc-complex-type.2.3"), // https://wiki.xmldation.com/Support/Validator/cvc-complex-type-2-3
  cvc_complex_type_2_2(
      "cvc-complex-type.2.2"), // https://wiki.xmldation.com/Support/Validator/cvc-complex-type-2-2
  cvc_complex_type_2_1(
      "cvc-complex-type.2.1"), // https://wiki.xmldation.com/Support/Validator/cvc-complex-type-2-1
  cvc_complex_type_2_4_a(
      "cvc-complex-type.2.4.a"), // https://wiki.xmldation.com/Support/Validator/cvc-complex-type-2-4-a
  cvc_complex_type_2_4_b(
      "cvc-complex-type.2.4.b"), // https://wiki.xmldation.com/Support/Validator/cvc-complex-type-2-4-b
  cvc_complex_type_2_4_c(
      "cvc-complex-type.2.4.c"), // https://wiki.xmldation.com/Support/Validator/cvc-complex-type-2-4-c
  cvc_complex_type_2_4_d(
      "cvc-complex-type.2.4.d"), // https://wiki.xmldation.com/Support/Validator/cvc-complex-type-2-4-d
  cvc_complex_type_2_4_f(
      "cvc-complex-type.2.4.f"), // https://wiki.xmldation.com/Support/Validator/cvc-complex-type-2-4-f
  cvc_complex_type_3_1(
      "cvc-complex-type.3.1"), // https://wiki.xmldation.com/Support/Validator/cvc-complex-type-3-1
  cvc_complex_type_3_2_2(
      "cvc-complex-type.3.2.2"), // https://wiki.xmldation.com/Support/Validator/cvc-complex-type-3-2-2
  cvc_complex_type_4(
      "cvc-complex-type.4"), // https://wiki.xmldation.com/Support/Validator/cvc-complex-type-4
  cvc_datatype_valid_1_2_1(
      "cvc-datatype-valid.1.2.1"), // https://wiki.xmldation.com/Support/Validator/cvc-datatype-valid-1-2-1
  cvc_datatype_valid_1_2_3(
      "cvc-datatype-valid.1.2.3"), // https://wiki.xmldation.com/Support/Validator/cvc-datatype-valid-1-2-3
  ...
  cvc_pattern_valid(
      "cvc-pattern-valid"), // https://wiki.xmldation.com/Support/Validator/cvc-pattern-valid
  ...
  cvc_attribute_3(
      "cvc-attribute.3"), // https://wiki.xmldation.com/Support/Validator/cvc-attribute-3
  cvc_enumeration_valid(
      "cvc-enumeration-valid"), // https://wiki.xmldation.com/Support/Validator/cvc-enumeration-valid
  cvc_maxlength_valid(
      "cvc-maxLength-valid"), // https://wiki.xmldation.com/Support/validator/cvc-maxlength-valid
  cvc_minlength_valid(
      "cvc-minLength-valid"), // https://wiki.xmldation.com/Support/validator/cvc-minlength-valid
  cvc_maxExclusive_valid(
      "cvc-maxExclusive-valid"), // https://wiki.xmldation.com/Support/validator/cvc-maxexclusive-valid
  cvc_maxInclusive_valid(
      "cvc-maxInclusive-valid"), // https://wiki.xmldation.com/Support/validator/cvc-maxinclusive-valid
  cvc_minExclusive_valid(
      "cvc-minExclusive-valid"), // https://wiki.xmldation.com/Support/validator/cvc-minexclusive-valid
  cvc_minInclusive_valid(
      "cvc-minInclusive-valid"), // https://wiki.xmldation.com/Support/validator/cvc-mininclusive-valid
   ...
   */
  public static Range toLSPRange(
      XMLLocator location, XMLSchemaErrorCode code, Object[] arguments, DOMDocument document) {
      ...
      case cvc_elt_3_1:
        {
          String namespaceAntAttrName =
              getString(arguments[1]); // http://www.w3.org/2001/XMLSchema-instance,nil
      ...
      case cvc_pattern_valid:
        {
          ...
          Range result =
              XMLPositionUtility.selectAttributeValueByGivenValueAt(value, offset, document);
          if (result != null) {
            return result;
          }
          ...
          if (DOMUtils.isXSD(document)) {
            ...
            if (locationRange == null) {
              NoNamespaceSchemaLocation noNamespaceSchemaLocation =
                  document.getNoNamespaceSchemaLocation();
              if (noNamespaceSchemaLocation != null) {
                ...
                if (schemaLocation != null) {
                  String invalidSchemaPath =
                      arguments[0] instanceof String ? (String) arguments[0] : null;

                  if (invalidSchemaPath != null) {
                    for (SchemaLocationHint locHintRange :
                        schemaLocation.getSchemaLocationHints()) {
                      String expandedHint =
                          getResolvedLocation(document.getDocumentURI(), locHintRange.getHint());
            ...
            return locationRange != null
                ? XMLPositionUtility.selectValueWithoutQuote(locationRange)
                : null;
          }
        }
      ...
      case cvc_minInclusive_valid:
        {
          ...
          Range range =
              XMLPositionUtility.selectAttributeValueFromGivenValue(attrValue, offset, document);
          if (range != null) {
            return range;
          } else {
            // Try with text
  ...
  public static void registerCodeActionParticipants(
      Map<String, ICodeActionParticipant> codeActions, SharedSettings sharedSettings) {
    ...
    if (sharedSettings != null
        && sharedSettings
            ...
            .isResourceOperationSupported(ResourceOperationKind.Create)) {
