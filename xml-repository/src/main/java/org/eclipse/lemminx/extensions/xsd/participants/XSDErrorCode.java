 ...
 *     <p>All error code types and messages can be found in the Xerces library
...
public enum XSDErrorCode implements IXMLErrorCode {
  ...
  public static Range toLSPRange(
      XMLLocator location, XSDErrorCode code, Object[] arguments, DOMDocument document) {
    ...
    switch (code) {
      ...
      case schema_reference_4:
        {
          return XMLPositionUtility.selectAttributeValueAt(
              XSDUtils.SCHEMA_LOCATION_ATTR, offset, true, document);
        }
      case EmptyTargetNamespace:
        return XMLPositionUtility.selectAttributeValueAt(
            XSDUtils.TARGET_NAMESPACE_ATTR, offset, document);
      case src_import_3_1:
        {
          ...
          if (elementHighlighted
              .getNodeName()
              .equals(XSDUtils.XS_SCHEMA_TAG)) { // `xs:schema` line is highlighted
            return XMLPositionUtility.selectChildNodeAttributeValueFromGivenNameAt(
                XSDUtils.XS_IMPORT_TAG, XSDUtils.NAMESPACE_ATTR, offset, document);
      ...
      case src_import_3_2:
        return XMLPositionUtility.selectChildNodeAttributeValueFromGivenNameAt(
            XSDUtils.XS_IMPORT_TAG, XSDUtils.SCHEMA_LOCATION_ATTR, offset, document);
    }
  ...
  public static void registerCodeActionParticipants(
      Map<String, ICodeActionParticipant> codeActions) {
