...
public class RelaxNGURIResolverExtension implements URIResolverExtension {
  ...
  private static final String RELAXNG_NAMESPACE_URI =
      "http://relaxng.org/ns/structure/1.0"; //$NON-NLS-1$

  private static final String RELAXNG_SYSTEM = "https://relaxng.org/relaxng.rng";

  private static final ResourceToDeploy RELAXNG_RESOURCE =
      new ResourceToDeploy(RELAXNG_SYSTEM, "schemas/relaxng/relaxng.rng");
  ...
  public String resolve(String baseLocation, String publicId, String systemId) {
    ...
    try {
      return CacheResourcesManager.getResourceCachePath(RELAXNG_RESOURCE)
          .toFile()
          .toURI()
          .toString();
    } catch (Exception e) {
