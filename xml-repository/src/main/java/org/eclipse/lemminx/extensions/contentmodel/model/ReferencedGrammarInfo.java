 ...
 *
 * <ul>
 *   <li>which XSD, DTD file is bound to the DOM document.
 *   <li>which binding strategies is used (catalog, file association, xsi:schemaLocation,
...
public class ReferencedGrammarInfo {
  ...
  public ReferencedGrammarInfo(
      ResolvedURIInfo resolvedURIInfo, GrammarCacheInfo grammarCacheInfo, Identifier identifier) {
  ...
  /**
   * Returns the resolved URI information (the result of the resolve and the resolution strategy (ex
   * : catalog, file association, etc)).
   *
   * @return the resolved URI information (the result of the resolve and the resolution strategy
   */
  ...
  /**
   * Returns the grammar cache information and null otherwise. (grammar is not a remote grammar with
   * http://)
   *
  ...
  /**
   * Returns the identifier (xml-model, xsi:schemaLocation, xsi:noNamespaceSchemaLocation, DOCTYPE)
   * and null otherwise.
   *
   * @return the identifier (xml-model, xsi:schemaLocation, xsi:noNamespaceSchemaLocation, DOCTYPE)
   *     and null otherwise.
   */
  ...
  /**
   * Returns the resolver which is used to resolve the identifier URI and null otherwise. Resolved
   * by can have values:
   *
   * <ul>
   *   <li>catalog
   *   <li>file association
   *   <li>embedded catalog.xsd
   *   <li>embedded xml.xsd
   *   <li>embedded xslt.xsd
   * </ul>
   *
   * @return the resolver which is used to resolve the identifier URI and null otherwise.
   */
