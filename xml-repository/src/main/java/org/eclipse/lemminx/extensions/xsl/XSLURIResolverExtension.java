...
public class XSLURIResolverExtension implements URIResolverExtension {
  ...
  private static final String XSL_NAMESPACE_URI =
      "http://www.w3.org/1999/XSL/Transform"; //$NON-NLS-1$

  private static final ResourceToDeploy XML_SCHEMA_10 =
      new ResourceToDeploy("https://www.w3.org/1999/11/xslt10.xsd", "/schemas/xslt/xslt-1.0.xsd");
  ...
  static {
    ...
    XSL_RESOURCES.put(
        ...
        new ResourceToDeploy(
            "https://www.w3.org/2007/schema-for-xslt20.xsd", "/schemas/xslt/xslt-2.0.xsd"));
    XSL_RESOURCES.put(
        "3.0",
        new ResourceToDeploy(
            "https://www.w3.org/TR/xslt-30/schema-for-xslt30.xsd", "/schemas/xslt/xslt-3.0.xsd"));
  }
  ...
  /**
   * Returns the version coming from xsl:stylesheet/@version of the XML document retrieved by the
   * given uri
   *
   * @param uri
   * @return the version coming from xsl:stylesheet/@version of the XML document retrieved by the
   *     given uri
   */
