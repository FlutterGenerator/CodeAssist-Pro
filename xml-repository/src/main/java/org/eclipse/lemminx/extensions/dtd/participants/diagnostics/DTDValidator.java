...
public class DTDValidator {
  ...
  public static void doDiagnostics(
    ...
    LSPErrorReporterForXML reporterForXML =
        new LSPErrorReporterForXML(
            document, diagnostics, contentModelManager, false, new HashMap<>());
    try {
      LSPXMLEntityManager entityManager =
          createXMLEntityManager(reporterForXML, entityResolver, validationSettings);
  ...
  private static LSPXMLEntityManager createXMLEntityManager(
      LSPErrorReporterForXML reporterForXML,
      XMLEntityResolver entityResolver,
      XMLValidationSettings validationSettings) {
