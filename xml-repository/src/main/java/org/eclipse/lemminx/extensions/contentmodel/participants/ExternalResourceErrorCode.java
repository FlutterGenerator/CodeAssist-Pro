...
/**
 * External resource error code when referenced XSD, DTD (with DOCTYPE, xsi:schemaLocation) is
 * downloaded.
 */
public enum ExternalResourceErrorCode implements IXMLErrorCode {
  ...
  public static void registerCodeActionParticipants(
      Map<String, ICodeActionParticipant> codeActionParticipants) {
    codeActionParticipants.put(
        DownloadResourceDisabled.getCode(), new DownloadDisabledResourceCodeAction());
  }
}
