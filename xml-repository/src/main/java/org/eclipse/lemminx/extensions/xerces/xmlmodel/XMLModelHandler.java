...
/**
 * Xerces component which associates a XML with several grammar (XML Schema, DTD, ..) by using
...
public class XMLModelHandler implements XMLComponent, XMLDocumentFilter {
  ...
  static {
    ...
    Iterator<XMLModelValidatorFactory> factories =
        ServiceLoader.load(XMLModelValidatorFactory.class).iterator();
