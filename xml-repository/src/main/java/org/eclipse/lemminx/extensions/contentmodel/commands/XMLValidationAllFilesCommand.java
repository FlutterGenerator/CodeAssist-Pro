 ...
 *
 * <ul>
 *   <li>clear the Xerces grammar pool (used by the Xerces validation) and the content model
 *       documents cache (used by the XML completion/hover based on the grammar)
 *   <li>trigger the validation for the all opened XML files
 * </ul>
 *
 * @author Angelo ZERR
 */
public class XMLValidationAllFilesCommand implements IDelegateCommandHandler {
  ...
  public XMLValidationAllFilesCommand(
