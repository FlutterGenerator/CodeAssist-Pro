 ...
 *
 * <ul>
 *   <li>sequenced if all children have the same order.
 *   <li>cardinalities for each child.
 * </ul>
 */
public class ChildrenProperties {
   ...
   *
   * @return true if tags for each child hierarchy have the same order and false otherwise.
   */
