...
public interface CMElementDeclaration {
  ...
  public static final Collection<CMElementDeclaration> ANY_ELEMENT_DECLARATIONS =
   ...
   * @return the possible declared elements at the given offset of the given parent element.
   */
  Collection<CMElementDeclaration> getPossibleElements(DOMElement parentElement, int offset);

  /**
   * Returns the declared element which matches the given XML tag name / namespace and null
   * otherwise.
   *
   * @param tag
   * @param namespace
   * @return the declared element which matches the given XML tag name / namespace and null
   *     otherwise.
   */
   ...
   * @return formatted documentation of the declared element, according to settings defined in
   *     <code>request</code>.
   */
  String getDocumentation(ISharedSettingsRequest request);

  /**
   * Returns true if the element cannot contains element children or text content and false
   * otherwise.
   *
   * @return true if the element cannot contains element children or text content and false
   *     otherwise.
   */
  boolean isEmpty();
   ...
   *
   * @return true if the element is a string type (ex : xs:string) and false otherwise.
   */
   ...
   *
   * @return true if the element can contains text and element both and false otherwise.
   */
   ...
   *
   * @return a list of required/non-optional child elements of the current element.
   */
