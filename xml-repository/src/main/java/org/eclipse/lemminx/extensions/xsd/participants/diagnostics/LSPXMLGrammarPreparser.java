...
/**
 * Xerces {@link XMLGrammarPreparser} doesn't provide the capability to override the {@link
 * XMLErrorReporter} which is required to get XMLl This class overrides {@link
 * XMLGrammarPreparser#preparseGrammar(String, XMLInputSource)} to use LSP error reporter.
 */
