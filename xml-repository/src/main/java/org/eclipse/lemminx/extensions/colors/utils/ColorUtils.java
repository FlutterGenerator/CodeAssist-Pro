 ...
 * Color utilities.
 *
 * <p>Some piece of code comes the vscode CSS language server written in TypeScript which has been
 * translated to Java.
 *
 * @see <a href=
...
public class ColorUtils {
  ...
  /**
   * Returns the RGB color presentation of the given <code>color</code> and <code>replace</code>
   * range.
   *
   * @param color the color.
   * @param replace the replace range.
   * @return the RGB color presentation of the given <code>color</code> and <code>range</code>.
   */
  ...
  /**
   * Returns the Hexa color presentation of the given <code>color</code> and <code>replace</code>
   * range.
   *
   * @param color the color.
   * @param replace the replace range.
   * @return the Hexa color presentation of the given <code>color</code> and <code>range</code>.
   */
  ...
  private static String getHexa(
      double red256, double green256, double blue256, Double alpha, boolean addHash) {
  ...
  private static Color colorFromHex(String text) {
    ...
    switch (text.length()) {
      ...
      case 6:
        {
          double red =
              (hexDigit(text.codePointAt(0)) * 0x10 + hexDigit(text.codePointAt(1))) / 255.0;
          double green =
              (hexDigit(text.codePointAt(2)) * 0x10 + hexDigit(text.codePointAt(3))) / 255.0;
          double blue =
              (hexDigit(text.codePointAt(4)) * 0x10 + hexDigit(text.codePointAt(5))) / 255.0;
          double alpha = 1;
          return new Color(red, green, blue, alpha);
        }
      case 8:
        {
          ...
          double blue =
              (hexDigit(text.codePointAt(4)) * 0x10 + hexDigit(text.codePointAt(5))) / 255.0;
          double alpha =
              (hexDigit(text.codePointAt(6)) * 0x10 + hexDigit(text.codePointAt(7))) / 255.0;
          return new Color(red, green, blue, alpha);
        }
    }
