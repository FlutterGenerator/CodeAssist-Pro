...
public class FileContentGeneratorSettings {
  ...
  /**
   * Returns the minimum number of appearances of an attribute for it to be considered a candidate
   * for an enumeration type
   *
   * @return the minimum number of appearances of an attribute for it to be considered a candidate
   *     for an enumeration type
   */
  ...
  /**
   * Set the minimum number of appearances of an attribute for it to be considered a candidate for
   * an enumeration type
   *
   * @param minEnumerationInstances the minimum number of appearances of an attribute for it to be
   ...
   *
   * @return the maximum number of distinct attribute values to be included in an enumeration.
   */
   ...
   *
   * @param maxEnumerationValues the maximum number of distinct attribute values to be included in
   *     an enumeration.
   */
  ...
  /**
   * Returns the ratio for an attribute will be regarded as an enumeration attribute only if the
   * number of instances divided by the number of distinct values is >= this ratio
   *
   * @return the ratio for an attribute will be regarded as an enumeration attribute only if the
   *     number of instances divided by the number of distinct values is >= this ratio
   */
  ...
  /**
   * Set the ratio for an attribute will be regarded as an enumeration attribute only if the number
   * of instances divided by the number of distinct values is >= this ratio
   *
   * @param minEnumerationRatio the ratio for an attribute will be regarded as an enumeration
   *     attribute only if the number of instances divided by the number of distinct values is >=
   *     this ratio
   */
  ...
  /**
   * Returns the minimum number of attributes that must appear, with the same value each time, for
   * the value to be regarded as FIXED.
   *
   * @return the minimum number of attributes that must appear, with the same value each time, for
   *     the value to be regarded as FIXED.
   */
  ...
  /**
   * Set the minimum number of attributes that must appear, with the same value each time, for the
   * value to be regarded as FIXED.
   *
   * @param minFixed the minimum number of attributes that must appear, with the same value each
  ...
  /**
   * Returns the minumum number of attribute values that must appear for the attribute to be
   * regarded as an ID value.
   *
   * @return the minumum number of attribute values that must appear for the attribute to be
   *     regarded as an ID value.
   */
  ...
  /**
   * Set the minumum number of attribute values that must appear for the attribute to be regarded as
   * an ID value.
   *
   * @param minIdValues the minumum number of attribute values that must appear for the attribute to
   *     be regarded as an ID value.
   */
   ...
   *
   * @return the maximum number of attribute values to be saved while checking for uniqueness.
   */
   ...
   *
   * @param maxIdValues the maximum number of attribute values to be saved while checking for
   *     uniqueness.
   */
