...
/**
 * {@link XMLEntityResolver} used when XML, XSD, DTD is validated and declared some external
 * resources (with DOCTYPE, xsi:schemaLocation, etc).
 *
 * <p>This resolver catches the {@link CacheResourceException} to collect all futures which loads
