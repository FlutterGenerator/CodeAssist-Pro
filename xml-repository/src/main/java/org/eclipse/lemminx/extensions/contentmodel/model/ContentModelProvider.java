...
public interface ContentModelProvider {
   ...
   * @param internal true if it is an internal content model (ex : DOCCTYPE subset) and false
   *     otherwise.
  ...
  /**
   * Returns true if the given resource uri can be adapted for this content model and false
   * otherwise.
   *
   * <p>o@param uri the resource Uri.
   *
   * @return true if the given resource uri can be adapted for this content model and false
   *     otherwise.
   */
   ...
   * @param resolveExternalEntities true if external entities can be resolved and false otherwise.
   * @return the content model document (XSD, DTD, etc) from the given resource key and null
   *     otherwise.
   */
   ...
   * @param xmlDocument the DOM document.
   * @param resolveExternalEntities true if external entities can be resolved and false otherwise.
   * @return the internal content model (for DOCTYPE subset) from the given DOM document.
   */
