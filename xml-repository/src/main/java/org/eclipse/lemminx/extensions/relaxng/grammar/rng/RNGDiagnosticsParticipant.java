...
public class RNGDiagnosticsParticipant implements IDiagnosticsParticipant {
  ...
  public void doDiagnostics(
    ...
    LSPXMLEntityResolver entityResolverWrapper =
        new LSPXMLEntityResolver(entityResolver, (DiagnosticsResult) diagnostics);
    ...
    RNGValidator.doDiagnostics(
        xmlDocument,
        entityResolverWrapper,
        diagnostics,
        validationSettings,
        rngPlugin.getContentModelManager(),
        monitor);
  }
