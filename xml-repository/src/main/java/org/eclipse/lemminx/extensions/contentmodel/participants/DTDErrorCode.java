...
public enum DTDErrorCode implements IXMLErrorCode {
  ...
  public static Range toLSPRange(
      XMLLocator location, DTDErrorCode code, Object[] arguments, DOMDocument document) {
      ...
      case EntityNotDeclared:
        {
          EntityReferenceRange range =
              XMLPositionUtility.selectEntityReference(offset - 1, document);
      ...
      case DTDNotFound:
        {
          ...
          try {
            ...
            if (docType != null) {
              ...
              String dtdLocation =
                  getResolvedLocation(documentURI, docType.getSystemIdWithoutQuotes());
  ...
  public static void registerCodeActionParticipants(
    ...
    codeActions.put(
        MSG_SPACE_REQUIRED_BEFORE_ELEMENT_TYPE_IN_ATTLISTDECL.getCode(), fixMissingSpace);
    codeActions.put(
        MSG_SPACE_REQUIRED_BEFORE_ELEMENT_TYPE_IN_ELEMENTDECL.getCode(), fixMissingSpace);
