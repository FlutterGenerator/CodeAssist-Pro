 ...
 * XML colors plugin.
 *
 * <p>This plugin provides the capability to support color with 'xml.colors' settings. <code>
 * "xml.colors": [
...
public class XMLColorsPlugin implements IXMLExtension {
  ...
  private void updateSettings(ISaveContext saveContext) {
    ...
    XMLColorsSettings referencesSettings =
        XMLColorsSettings.getXMLColorsSettings(initializationOptionsSettings);
