...
class XSDAnnotationModel {
   ...
   * Returns the prefix (ie. xs) from the provided collection of annotations
   *
   * <p>Prerequisite: <code>value</code> should be provided if <code>annotations</code> is a
   * collection of attribute value annotations
   *
   * @param annotations the collection of annotations
  ...
  /**
   * Returns the <code>XSAnnotation</code> instance for the provided <code>annotation</code> If
   * <code>value</code> is provided, the <code>XSAnnotation</code> for an attribute value will be
   * searched for
   *
   * <p>If not provided, the <code>XSAnnotation</code> for an attribute or element will be searched
   * for
   *
   * @param annotation the annotation object
   * @param value the attribute value
   * @return the <code>XSAnnotation</code> instance for the provided <code>annotation</code>
   */
