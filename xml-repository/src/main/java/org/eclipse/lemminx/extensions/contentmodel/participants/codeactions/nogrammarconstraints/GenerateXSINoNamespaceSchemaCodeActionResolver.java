 ...
 *
 * <ul>
 *   <li>generate the XSD file for the given DOM document
 *   <li>generate the association xsi:noNamespaceSchemaLocation in the XML to bind it with the
 *       generated XSD
 * </ul>
 *
 * @author Angelo ZERR
...
public class GenerateXSINoNamespaceSchemaCodeActionResolver
  ...
  public static final String PARTICIPANT_ID =
      GenerateXSINoNamespaceSchemaCodeActionResolver.class.getName();

  @Override
  protected TextDocumentEdit createFileEdit(
