...
/**
 * The root diagnostic information when a grammar (XSD, DTD) have some errors and it is referenced
 * in a XML. The diagnostic range covers teh location where the grammar is declared (with DOCTYPE
 * SYSTEM, xsi:noNamespaceSchemaLocation, etc).
 *
 * @author Angelo ZERR
 */
public class ReferencedGrammarDiagnosticsInfo {
  ...
  public ReferencedGrammarDiagnosticsInfo(
      String grammarURI,
