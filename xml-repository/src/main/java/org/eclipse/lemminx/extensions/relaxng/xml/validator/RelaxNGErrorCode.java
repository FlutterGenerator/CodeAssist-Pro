...
public enum RelaxNGErrorCode implements IXMLErrorCode {
  ...
  public static Range toLSPRange(
      XMLLocator location, RelaxNGErrorCode rngCode, Object[] arguments, DOMDocument document) {
    ...
    switch (rngCode) {
      ...
      case missing_start_element:
        {
          ...
          if (node != null) {
            if (node.isElement()
                && RelaxNGUtils.GRAMMAR_TAG.equals(((DOMElement) node).getLocalName())) {
      ...
      case illegal_name_attribute:
        {
          return XMLPositionUtility.selectAttributeNameFromGivenNameAt(
              RelaxNGUtils.NAME_ATTR, offset, document);
        }
      ...
      case invalid_ncname:
        {
          ...
          if (node != null
            ...
            return hasText
                ? XMLPositionUtility.selectText((DOMText) name.getFirstChild())
                : XMLPositionUtility.selectStartTagName((DOMElement) node);
          }
          // <element name="::::"></element>
          return XMLPositionUtility.selectAttributeValueAt(
              RelaxNGUtils.NAME_ATTR, offset, false, document);
        }
  ...
  public static void registerCodeActionParticipants(
    ...
    codeActions.put(
        incomplete_element_required_element_missing.getCode(),
        new required_element_missingCodeAction());
    codeActions.put(
        incomplete_element_required_elements_missing_expected.getCode(),
        new required_elements_missing_expectedCodeAction());
  }
