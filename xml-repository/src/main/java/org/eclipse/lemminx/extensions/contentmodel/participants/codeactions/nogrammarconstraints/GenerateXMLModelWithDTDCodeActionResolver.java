 ...
 *
 * <ul>
 *   <li>generate the DTD file for the given DOM document
 *   <li>generate the association xml-model in the XML to bind it with the generated DTD
 * </ul>
 *
 * @author Angelo ZERR
 */
public class GenerateXMLModelWithDTDCodeActionResolver
  ...
  public static final String PARTICIPANT_ID =
      GenerateXMLModelWithDTDCodeActionResolver.class.getName();
