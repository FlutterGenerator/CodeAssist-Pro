...
/**
 * RelaxNG class used to collect content model attributes for a given {@link ElementPattern}.
 *
...
public class CMRelaxNGAttributeDeclarationCollector extends AbstractCMRelaxNGCollector {
  ...
  public CMRelaxNGAttributeDeclarationCollector(
      CMRelaxNGElementDeclaration elementDeclaration, Pattern pattern) {
  ...
  public VoidValue caseAttribute(AttributePattern p) {
    ...
    if (nameClass instanceof SimpleNameClass) {
      CMRelaxNGAttributeDeclaration attributeDeclaration =
          new CMRelaxNGAttributeDeclaration(elementDeclaration, p);
