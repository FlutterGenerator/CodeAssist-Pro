...
public class CMRelaxNGAttributeDeclaration implements CMAttributeDeclaration {
  ...
  public CMRelaxNGAttributeDeclaration(
      CMRelaxNGElementDeclaration element, AttributePattern pattern) {
  ...
  public String getPrefix() {
    ...
    DOMElement element =
        ((CMRelaxNGElementDeclaration) getOwnerElementDeclaration()).getDOMElement();
    if (element != null) {
  ...
  public String getAttributeValueDocumentation(String value, ISharedSettingsRequest request) {
    if (!getEnumerationValues().isEmpty()) {
      String documentation =
          cmElement.getCMDocument().getDocumentation(pattern.getLocator(), value);
