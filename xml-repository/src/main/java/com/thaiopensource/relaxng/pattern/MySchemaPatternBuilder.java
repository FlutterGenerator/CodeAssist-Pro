...
/**
 * This class extends {@link SchemaPatternBuilder} to copy the {@link Locator} when {@link
 * ElementPattern} and {@link AttributePattern} are created, because by default the received locator
 * instance is a singleton and we loose the correct line/character position.
 *
 * @author Angelo ZERR
 */
