...
public class DependencyManager {
    ...
    public static List<RepositoryModel> parseFile(File file) throws IOException {
        try {
            ...
            Type type = new TypeToken<List<RepositoryModel>>() {
            }.getType();
    ...
    public void resolve(JavaModule project, ProjectManager.TaskListener listener, ILogger logger)
        ...
        while (!projects.isEmpty()) {
            ...
            if (gradleFile.exists()) {
                List<String> includedInBuildGradle = new ArrayList<>(project.getAllProjects(gradleFile));
    ...
    public Set<CodeAssistLibrary> parseLibraries(
        ...
        try {
            List<CodeAssistLibrary> parsedLibraries =
                    new Gson()
                            .fromJson(librariesString, new TypeToken<List<CodeAssistLibrary>>() {
                            }.getType());
