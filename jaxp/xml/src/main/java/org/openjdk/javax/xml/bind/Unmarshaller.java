...
import org.openjdk.javax.xml.bind.attachment.AttachmentUnmarshaller;
 ...
 * {@codeorg.openjdk.javax.xml.transform.stream.StreamSource}:
 * <blockquote>
 *    <pre>{@code
 *       JAXBContext jc = JAXBContext.newInstance( "com.acme.foo" );
 *       Unmarshaller u = jc.createUnmarshaller();
 ...
 * 
 * <p>
 * Unmarshalling from a {@codeorg.openjdk.javax.xml.transform.sax.SAXSource} using a
 ...
 *          org.openjdk.javax.xml.stream.XMLInputFactory().newInstance().createXMLStreamReader( ... );
 * 
 ...
 *       Unmarshaller u = jc.createUnmarshaller();
 * 
 *      org.openjdk.javax.xml.stream.XMLEventReader xmlEventReader = 
 *          org.openjdk.javax.xml.stream.XMLInputFactory().newInstance().createXMLEventReader( ... );
 * 
 ...
 * {@linkorg.openjdk.javax.xml.bind.helpers.DefaultValidationEventHandler} and it
...
public interface Unmarshaller {
     ...
     */
    public Object unmarshal(org.openjdk.javax.xml.transform.Source source )
        throws JAXBException;
     ...
     */
    public Object unmarshal(org.openjdk.javax.xml.stream.XMLStreamReader reader )
        throws JAXBException;
     ...
     * @since 1.6, JAXB 2.0
     */
    public <T> JAXBElement<T> unmarshal(org.openjdk.javax.xml.stream.XMLStreamReader reader, Class<T> declaredType ) throws JAXBException;
     ...
     */
    public Object unmarshal(org.openjdk.javax.xml.stream.XMLEventReader reader )
        throws JAXBException;
     ...
     * @since 1.6, JAXB 2.0
     */
    public <T> JAXBElement<T> unmarshal(org.openjdk.javax.xml.stream.XMLEventReader reader, Class<T> declaredType ) throws JAXBException;
