...
public final class Environment {
  ...
  public static final String DEFAULT_ROOT = "/data/data/" + "dev.mutwakil.codeassist" + "/files";
  ...
  private static final String ANDROID_JAR_HOME = DEFAULT_ANDROID_HOME + "/platforms/android-" + "36";
