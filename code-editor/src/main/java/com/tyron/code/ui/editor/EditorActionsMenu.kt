...
import com.tyron.resources.databinding.LayoutPopupMenuItemBinding
import com.tyron.code.ui.editor.EditorActionsMenu.ActionsListAdapter.VH
...
open class EditorActionsMenu(val editor: IDEEditor) :
  ...
  private fun selectTop(rect: RectF): Int {
    ...
    return if ((rect.top - rowHeight * 3 / 2f).compareTo(height) > 0) {
  ...
  protected open fun onCreateActionData(): ActionData {
    ...
    data.put(Range::class.java, editor.cursorLSPRange)
//    data.put(
