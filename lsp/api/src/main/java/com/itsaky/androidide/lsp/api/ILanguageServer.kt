...
interface ILanguageServer {
	 ...
	 */
	fun setupWithProject(workspace: Project)
	...
	fun signatureHelpBlocking(params: SignatureHelpParams): SignatureHelp =
		runBlocking { signatureHelp(params) }
	 ...
	 */
	fun formatCode(params: FormatCodeParams?): CodeFormatResult = CodeFormatResult(false, mutableListOf())
	 ...
	 */
	fun handleFailure(failure: LSPFailure?): Boolean = false
}
